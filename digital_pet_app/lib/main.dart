...
class _DigitalPetAppState extends State<DigitalPetApp> {
  ...
  // pick the tint based on happiness
  ...
  // adjust happiness after feeding
  ...
  // hunger goes up over time + after play
  void _updateHunger() {
    setState(() {
      hungerLevel += 5;
      if (hungerLevel > 100) {
